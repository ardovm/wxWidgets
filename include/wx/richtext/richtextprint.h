...
{
public:
    wxRichTextPrintout(const wxString& title = wxGetTranslation(wxASCII_STR("Printout")));
...
{
public:
    wxRichTextPrinting(const wxString& name = wxGetTranslation(wxASCII_STR("Printing")), wxWindow *parentWindow = NULL);
